...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"plugins/select.js":[function(require,module,exports) {
"use strict";
...
var _getTemplate = function _getTemplate() {
  ...
  var placeholder = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'Select from here';
  var defaultId = arguments.length > 2 ? arguments[2] : undefined;
  ...
  var items = data.map(function (item) {
    ...
    return "<li class=\"".concat(cls, "\" data-type=\"item\" data-id=\"").concat(item.id, "\">").concat(item.value, "</li>");
  }).join('');
  return "\n        <div class=\"select__backdrop\" data-type=\"backdrop\"></div>\n            <div class=\"select__input\" data-type=\"input\">\n                <span id=\"value\" data-type=\"input\">".concat(text, "</span>\n                <i class=\"fas dropdown-img fa-caret-down\" data-type=\"arrow\"></i>\n            </div>\n            <div class=\"select__dropdown\">\n                <ul class=\"select__list\">                    \n                    ").concat(items, "\n                </ul>\n            </div>\n            ");
};
...
var Select = /*#__PURE__*/function () {
  function Select(selector, options) {
    ...
    _defineProperty(this, "className", 'select');
  ...
  _createClass(Select, [{
    ...
    key: "changeArrow",
    value: function changeArrow() {
      var classToRemove = this.isOpen ? 'fa-caret-down' : 'fa-caret-up';
      var classToAdd = this.isOpen ? 'fa-caret-up' : 'fa-caret-down';
